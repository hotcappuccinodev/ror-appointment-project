...
user1 = User.create!(name: 'John Doe', email: 'john@gmail.com', password: 'test123', roles: ['admin'])
user2 = User.create!(name: 'Jane Doe', email: 'jane@gmail.com', password: 'test123', roles: ['admin'])
